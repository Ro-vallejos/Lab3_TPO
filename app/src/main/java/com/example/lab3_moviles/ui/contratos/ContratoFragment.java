...
import com.example.lab3_moviles.ui.inmuebles.InmuebleAdapter;
           ...
           public void onChanged(List<Inmueble> inmuebles) {
               ContratoAdapter card = new ContratoAdapter(inmuebles,getLayoutInflater(),getContext(), new ContratoAdapter.verDetalleClicListener() {
                   ...
                   public void verListener(Inmueble inmueble) {
                       ...
                       Navigation.findNavController(getActivity(),R.id.nav_host_fragment_content_main).navigate(R.id.nav_detalleContrato,bundle);
                   }
               });
